        ...
        <td background="images/index/fooder_bg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    %>
                    <td>&nbsp;&nbsp;<font style="font-size: 16px">当前用户：<%=orgnaName%>&nbsp;&nbsp;<%=cUser.getRealName()%>&nbsp;&nbsp;</font></td>
                    <td></td>
                    <td><img src="images/index/fooder_line.gif" width="2" height="24"/></td>
                    <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font style="font-size: 16px">黄河钻井三公司办公自动化系统</font>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font style="font-size: 16px"><a href="soft/WebSign.exe">Web签字查看组件</a>  <a href="soft/MakeSeal.exe">制作签章工具</a></font>
                        &nbsp;&nbsp;
                    </td>
                    <td><img src="images/index/fooder_line.gif" width="2" height="24"/></td>
                </tr>
