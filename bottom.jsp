...
//       	if (obj)obj.onclick();	
        ...
        function openOnlineUsers(){
            parent.open("onlineUsers.jsp","contentFrame");
        }
    </script>
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="images2/index_59.gif">
    <tr>
        ...
        <td class="txt2"><font style="font-size: 12px"><a href="soft/WebSign.exe">Web签字查看组件</a>  <a href="soft/MakeSeal.exe">制作签章工具</a></font>&nbsp;</td>
        <td class="txt2">&nbsp;&nbsp;</td>
    </tr>
</table>
</body>
