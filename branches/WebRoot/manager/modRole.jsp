            ...
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablett" style="BORDER-COLLAPSE: collapse">
                    <tr>
                        ...
                        <td class="head_right"><input name="role.roleName" type="text" id="roleName"  value="${role.roleName}"/></td>
                    </tr>
                    <tr>
                        <td class="head_left">角色描述：</td>
                        <td class="head_right"><textarea name="role.roleDesc" cols="50" rows="5" id="roleDesc">${role.roleDesc}</textarea></td>
                    </tr>
                    <tr>
                        <td class="head_left">排列序号：</td>
                        <td class="head_right"><input name="role.roleOrder" type="text" id="roleOrder" value="${role.roleOrder}"/>
                        </td>
                    </tr>
