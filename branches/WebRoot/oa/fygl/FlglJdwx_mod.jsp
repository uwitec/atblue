...
<form action="FlglJdwx_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="lbbm" value="<s:property value="lbbm"/>"/>
    <input type="hidden" name="bean.lbbm" value="<s:property value="bean.lbbm"/>"/>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <%--<tr>--%>
                            ...
                            <%--<td class="head_right" align="left" style="text-align: left">--%>
                                    <%--<input type="text" name="bean.lbbm" value="<s:property value="bean.lbbm"/>"/>--%>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.lbmc" value="<s:property value="bean.lbmc"/>"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                <textarea name="bean.lbms" rows="5" cols="40" style="width: 100%"><s:property value="bean.lbms"/></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td nowrap="nowrap" width="120" class="head_left">
