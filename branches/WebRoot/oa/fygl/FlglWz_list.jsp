            ...
            <td align="left" class="mhead">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">
                            &nbsp;&nbsp;&nbsp;
                            <input type="button" class="button" onclick="window.location = 'FlglWz_add.d';" style="width:40px"  value='新增'>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <table width="100%" border="0" align="center" cellpadding="0"  id="tab_id" name="tab_id"
                ...
                <s:iterator value="dataList" status="status">
                    <tr onclick="setSelected(this,'tab_id','tr_head','<s:property value="LBBM"/>')">
                        ...
                        <td class="form_th" style="text-align: center" nowrap>
                            <a href="./FlglWz_mod.d?bm=<s:property value="LBBM"/>">[编辑]</a>&nbsp;
                            <a href="javascript:onDelete('./FlglWz_del.d?bm=<s:property value="LBBM"/>');">[删除]</a>&nbsp;
                        </td>
                    </tr>
                </s:iterator>
            </table>
