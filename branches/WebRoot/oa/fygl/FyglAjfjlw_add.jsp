                ...
                <div id="scrollDiv"
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.fwnr" value=""/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.ggxh" value=""/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.xz" value=""/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.dj" value="" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 &&
(event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.sl" value="" onKeypress="if((event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.je" value="" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 &&
(event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
