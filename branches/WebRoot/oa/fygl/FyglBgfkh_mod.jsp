...
<form action="FyglBgfkh_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="bgfkhbm" value="<s:property value="bgfkhbm"/>"/>
    <input type="hidden" name="bean.bgfkhbm" value="<s:property value="bean.bgfkhbm"/>"/>
