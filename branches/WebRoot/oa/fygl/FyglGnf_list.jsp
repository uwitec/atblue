                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <input type="button" class="button" onclick="window.location = 'FyglGnf_add.d';" style="width:40px"  value='新增'>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="0"  id="tab_id" name="tab_id"
                ...
                <s:iterator value="dataList" status="status">
                    <tr onclick="setSelected(this,'tab_id','tr_head','<s:property value="GNFBM"/>')">
                        ...
                        <td class="form_th" style="text-align: left" nowrap><s:property value="WJRQ"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="GNFY"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="DEZQ"/>&nbsp;</td>
                        <td class="form_th" style="text-align: center" nowrap>
                            <a href="./FyglGnf_mod.d?bm=<s:property value="GNFBM"/>">[编辑]</a>&nbsp;
                            <a href="javascript:onDelete('./FyglGnf_del.d?bm=<s:property value="GNFBM"/>');">[删除]</a>&nbsp;
                        </td>
                    </tr>
                </s:iterator>
            </table>
