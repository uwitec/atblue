...
<form action="FyglGyfw_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="gyfwbm" value="<s:property value="gyfwbm"/>"/>
    <input type="hidden" name="bean.gyfwbm" value="<s:property value="bean.gyfwbm"/>"/>
                ...
                <div id="scrollDiv"
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.jdfwfy" value="<s:property value="bean.jdfwfy"/>" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.fwzlpj" value="<s:property value="bean.fwzlpj"/>"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.kk" value="<s:property value="bean.kk"/>" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.sjfy" value="<s:property value="bean.sjfy"/>" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
