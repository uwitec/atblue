...
<form action="FyglKzjzqys_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="kzjbm" value="<s:property value="kzjbm"/>"/>
    <input type="hidden" name="bean.kzjbm" value="<s:property value="bean.kzjbm"/>"/>
                ...
                <div id="scrollDiv"
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.sjzq" value="<s:property value="bean.sjzq"/>"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.dezq" value="<s:property value="bean.dezq"/>"/>
