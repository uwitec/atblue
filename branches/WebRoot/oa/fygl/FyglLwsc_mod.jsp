...
<form action="FyglLwsc_save.d" name="form1" method="post">
    ...
    <input type="hidden" name="lwscbm" value="<s:property value="lwscbm"/>"/>
    <input type="hidden" name="bean.lwscbm" value="<s:property value="bean.lwscbm"/>"/>
                ...
                <div id="scrollDiv"
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.ydw" value="<s:property value="bean.ydw"/>"/>
