...
<form action="FyglPbyf_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="pbbm" value="<s:property value="pbbm"/>"/>
    <input type="hidden" name="bean.pbbm" value="<s:property value="bean.pbbm"/>"/>
