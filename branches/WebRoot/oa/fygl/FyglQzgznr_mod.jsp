...
<form action="FyglQzgznr_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="nrbm" value="<s:property value="nrbm"/>"/>
    <input type="hidden" name="bean.nrbm" value="<s:property value="bean.nrbm"/>"/>
                ...
                <div id="scrollDiv"
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.nrms" value="<s:property value="bean.nrms"/>"/>
