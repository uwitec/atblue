                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <input type="button" class="button" onclick="window.location = 'FyglScfzyf_add.d';" style="width:40px"  value='新增'>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="0"  id="tab_id" name="tab_id"
                ...
                <s:iterator value="dataList" status="status">
                    <tr onclick="setSelected(this,'tab_id','tr_head','<s:property value="SCFZBM"/>')">
                        <td class="form_th" style="text-align: center" nowrap>
                            <s:property value="#status.index+1"/>
                        </td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="YCRQ"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="YCDW"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="CXSL"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="FWDW"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="TBF"/>&nbsp;</td>
                        ...
                        <td class="form_th" style="text-align: left" nowrap><s:property value="GZNR"/>&nbsp;</td>
                        <td class="form_th" style="text-align: center" nowrap>
                            <a href="./FyglScfzyf_mod.d?bm=<s:property value="SCFZBM"/>">[编辑]</a>&nbsp;
                            <a href="javascript:onDelete('./FyglScfzyf_del.d?bm=<s:property value="SCFZBM"/>');">[删除]</a>&nbsp;
                        </td>
                    </tr>
                </s:iterator>
            </table>
