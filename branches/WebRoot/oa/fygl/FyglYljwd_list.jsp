                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <input type="button" class="button" onclick="window.location = 'FyglYljwd_add.d';" style="width:40px"  value='新增'>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="0"  id="tab_id" name="tab_id"
                ...
                <s:iterator value="dataList" status="status">
                    <tr onclick="setSelected(this,'tab_id','tr_head','<s:property value="YLBM"/>')">
                        <td class="form_th" style="text-align: center" nowrap>
                            <s:property value="#status.index+1"/>
                        </td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="GYRQ"/>&nbsp;</td>
                        ...
                        <td class="form_th" style="text-align: left" nowrap><s:property value="YFJLW"/>&nbsp;</td>
                        <td class="form_th" style="text-align: center" nowrap>
                            <a href="./FyglYljwd_mod.d?bm=<s:property value="YLBM"/>">[编辑]</a>&nbsp;
                            <a href="javascript:onDelete('./FyglYljwd_del.d?bm=<s:property value="YLBM"/>');">[删除]</a>&nbsp;
                        </td>
                    </tr>
                </s:iterator>
            </table>
