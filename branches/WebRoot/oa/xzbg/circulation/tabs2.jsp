...
Ext.onReady(function(){
	tabpanel = new Ext.TabPanel({
	   ...
	   items:[
	   {
	       ...
	       closable: false,     //允许关闭
	       //通过html载入目标页
	       html: '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="check_index.jsp"  name="frame"></iframe>'
	   } ,
	{
	    'id': '已传阅',
	    autoScroll: true,   //溢出时显示滚动条
	    ...
	    closable: false,     //允许关闭
	    //通过html载入目标页
	        html: '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="check_index2.jsp"  name="frame" id="frame" ></iframe>'
	}
       ]
    });
