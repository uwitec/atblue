...
<%
	...
	int totalRow =oDao.getWaitPagedOfficeCirculationCount(paramMap);
	pageBean.setTotalRows(totalRow);
	List list = oDao.getWaitPagedOfficeCirculationList(pageBean,paramMap);
%>
        ...
        <tr>
            ...
            <td align="left" class="mhead">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">
                            <font style="font-size: 16px"> 文件名称：</font>
				...
				<td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						* (pageBean.getCurrentPage() - 1) + i + 1%>
							...
							<td  style="text-align: center" nowrap="nowrap" nowrap="nowrap">
