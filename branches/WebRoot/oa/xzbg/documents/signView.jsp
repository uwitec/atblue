...
<%
	...
	//签收
	OfficeDocumentsCheck _odc = officeDocumentsCheckDAO.selectByDocumentidCheckMan(document.getDocumentid(), _user.getUserId());
	if(_odc.getCheckflag().equals("0")){
		_odc.setCheckflag("1");
		_odc.setChecktime(new Timestamp(DateUtil.getDateTime().getTime()));
		_odc.setIp(request.getRemoteAddr());
		officeDocumentsCheckDAO.updateByPrimaryKey(_odc);
	}
