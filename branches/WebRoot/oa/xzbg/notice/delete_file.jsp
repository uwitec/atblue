...
<%
	...
	if(fileList!=null && fileList.size()>0){
		for(int k=0; k<fileList.size(); k++){
			...
			sb.append("<a href=\"../../officeFileDownload?pkid=" + file.getPkid() + "\">");
			sb.append("<img src=\"../../resource/fileIco/" + file.getWjlx() + ".png\" onerror=\"this.src='../resource/fileIco/other.png'\" style=\"cursor: pointer;\" border=\"0\"");
