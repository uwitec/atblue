	...
	<head>
		...
		<script type="text/javascript">
            ...
            function qz(){
                window
                        .open(
                        "<%=request.getContextPath()%>/oa/qpd/qpd.jsp?formId=de9354f5-7d7f-410c-a5bd-3cbd777d1525&connectId=<%=connectId%>&processId=<%=processId%>",
                        "mywindow",
                        "height="
                                + 500
                                + ",width="
		...
		<form action="add.jsp" name="form1" method="post">
			...
			<table width="100%" height="25" border="0" cellpadding="0"
				...
				<tr>
					...
					<td width="30%" class="mhead">
						查看<%=officePlanProcess.getBt() %>
					</td>
					<td width="60%" align="left" class="mhead">
					</td>
				</tr>
			</table>
			<table>
