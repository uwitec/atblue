...
<%
	...
	FileUploadUtil fileUpload = new FileUploadUtil(request);
        ...
        sqid = StringUtil.parseNull(fileUpload.getParameter("sqid"),"");
						...
						<div id="scrollDiv"
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="head_right" style="text-align: left">
									<textarea cols="80" id="editor" name="editor" rows="15" style="width:100%" class="xheditor {submitID:'form1'}"><%=StringUtil.parseNull(officeSupplies.getSy(),"")%></textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="head_right" align="left" id="hasFile"  style="text-align: left">
										<%
											...
											<a href="javascript:delFile('<%=beanFile.getPkid() %>','<%=sqid %>')">[删除]</a></br>
									     <%}%>
									</td>
								</tr>
								<%} %>
