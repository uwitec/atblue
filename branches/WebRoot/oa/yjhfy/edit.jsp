...
<html>
	...
	<body onload="_resizeNoPage();">
		<form action="edit.jsp" name="form1" method="post">
            ...
            <input type="hidden" name="sqid" value="<%=StringUtil.parseNull(request.getParameter("sqid"),"")%>"/>
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="FZBM" value="<%=StringUtil.parseNull(bean.getFzbm(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        季度<span style="color: red">&nbsp;*</span>
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="JD" value="<%=StringUtil.parseNull(bean.getJd(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="FYMC" value="<%=StringUtil.parseNull(bean.getFymc(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        费用项目
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="FYXM" value="<%=StringUtil.parseNull(bean.getFyxm(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <textarea rows="4" cols="20" name="XMMX" style="width:100%"><%=StringUtil.parseNull(bean.getXmmx(),"")%></textarea>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        型号规格
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="XHGZ" value="<%=StringUtil.parseNull(bean.getXhgz(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="DW" value="<%=StringUtil.parseNull(bean.getDw(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        单价（元）
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="DJ" value="<%=StringUtil.parseNull(bean.getDj(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="DJ2" value="<%=StringUtil.parseNull(bean.getDj2(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        数量
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="SL" value="<%=StringUtil.parseNull(bean.getSl(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="YJFY" value="<%=StringUtil.parseNull(bean.getYjfy(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        定价依据
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="DJYJ" value="<%=StringUtil.parseNull(bean.getDjyj(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="TJFWCS1" value="<%=StringUtil.parseNull(bean.getTjfwcs1(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        有无市场准入证
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="YWZRZ1" value="<%=StringUtil.parseNull(bean.getYwzrz1(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="TJFWCS2" value="<%=StringUtil.parseNull(bean.getTjfwcs2(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        有无市场准入证
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="YWZRZ2" value="<%=StringUtil.parseNull(bean.getYwzrz2(),"")%>"  style="width:100%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                    ...
                                    <td class="head_right" style="text-align: left">
                                        <input type="text" name="FSYF" value="<%=StringUtil.parseNull(bean.getFsyf(),"")%>"  style="width:100%"/>
                                    </td>
                                    <td nowrap="nowrap" width="200" class="head_left">
                                        备注
                                    </td>
                                    <td class="head_right" style="text-align: left">
                                        <textarea rows="4" cols="20" name="BZ" style="width:100%"><%=StringUtil.parseNull(bean.getBz(),"")%></textarea>
                                    </td>
                                </tr>
                            </table>
						</div>
