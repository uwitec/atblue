...
public class FlglJdwxAction extends BaseAction {
private Dao dao;
private ODao oDao;
private FlglJdwxDAO flglJdwxDAO;

private FlglJdwx bean;
...
map.put("mc", mc);
int cn = flglJdwxDAO.getPagedCount(map);
...
this.dataList = flglJdwxDAO.getPagedList(map);
return "list";
}
...
Map map = new HashMap();
map.put("lbbm", bm);
this.bean = flglJdwxDAO.queryForBean(map);
}
return "mod";
}
...
flglJdwxDAO.addFlglJdwx(bean);
} else if ("save".equals(action)) {
flglJdwxDAO.modFlglJdwx(bean);
}
}
return "save";
}
...
public FlglJdwxDAO getFlglJdwxDAO() {
return flglJdwxDAO;
}

public void setFlglJdwxDAO(FlglJdwxDAO flglJdwxDAO) {
this.flglJdwxDAO = flglJdwxDAO;
}

public FlglJdwx getBean() {
return bean;
}

public void setBean(FlglJdwx bean) {
this.bean = bean;
}
