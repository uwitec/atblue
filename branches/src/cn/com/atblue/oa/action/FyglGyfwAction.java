...
public class FyglGyfwAction extends BaseAction {
private Dao dao;
private ODao oDao;
private FyglGyfwDAO fyglGyfwDAO;

private FyglGyfw bean;
...
map.put("mc", mc);
int cn = fyglGyfwDAO.getPagedCount(map);
...
this.dataList = fyglGyfwDAO.getPagedList(map);
return "list";
}
...
Map map = new HashMap();
map.put("gyfwbm", bm);
this.bean = fyglGyfwDAO.queryForBean(map);
}
return "mod";
}
...
bean.setGyfwbm(StringUtil.getUUID());
fyglGyfwDAO.addFyglGyfw(bean);
} else if ("save".equals(action)) {
fyglGyfwDAO.modFyglGyfw(bean);
}
}
return "save";
}
...
public FyglGyfwDAO getFyglGyfwDAO() {
return fyglGyfwDAO;
}

public void setFyglGyfwDAO(FyglGyfwDAO fyglGyfwDAO) {
this.fyglGyfwDAO = fyglGyfwDAO;
}

public FyglGyfw getBean() {
return bean;
}

public void setBean(FyglGyfw bean) {
this.bean = bean;
}
