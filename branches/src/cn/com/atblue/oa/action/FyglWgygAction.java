...
public class FyglWgygAction extends BaseAction {
private Dao dao;
private ODao oDao;
private FyglWgygDAO fyglWgygDAO;

private FyglWgyg bean;
...
map.put("mc", mc);
int cn = fyglWgygDAO.getPagedCount(map);
...
this.dataList = fyglWgygDAO.getPagedList(map);
return "list";
}
...
Map map = new HashMap();
map.put("wgygbm", bm);
this.bean = fyglWgygDAO.queryForBean(map);
}
return "mod";
}
...
bean.setWgygbm(StringUtil.getUUID());
fyglWgygDAO.addFyglWgyg(bean);
} else if ("save".equals(action)) {
fyglWgygDAO.modFyglWgyg(bean);
}
}
return "save";
}
...
public FyglWgygDAO getFyglWgygDAO() {
return fyglWgygDAO;
}

public void setFyglWgygDAO(FyglWgygDAO fyglWgygDAO) {
this.fyglWgygDAO = fyglWgygDAO;
}

public FyglWgyg getBean() {
return bean;
}

public void setBean(FyglWgyg bean) {
this.bean = bean;
}
