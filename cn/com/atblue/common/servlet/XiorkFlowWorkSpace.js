...
//
XiorkFlowWorkSpace.BASE_PATH = "$$$$$$$$$$/";

//
XiorkFlowWorkSpace.SAVE_PATH = XiorkFlowWorkSpace.BASE_PATH + "workflow/";

//
XiorkFlowWorkSpace.XIORK_FLOW_PATH = XiorkFlowWorkSpace.BASE_PATH + "workflow/resource/";

//
XiorkFlowWorkSpace.DEFAULT_PROCESS_NAME = "default";

XiorkFlowWorkSpace.URL_ADD_PROCESS =  "workflow_save.d";
XiorkFlowWorkSpace.URL_DELETE_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "deleteprocess.xf";
XiorkFlowWorkSpace.URL_GET_PROCESS = "workflow_get.d";
XiorkFlowWorkSpace.URL_LIST_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "listprocess.xf";
XiorkFlowWorkSpace.URL_UPDATE_PROCESS = "workflow_save.d";
...
XiorkFlowWorkSpace.META_NODE_COLOR_RED = "red";
XiorkFlowWorkSpace.META_NODE_COLOR_GREEN = "green";
//
/**
 * 建立工作空间
 */
XiorkFlowWorkSpace.build = function () {
    ...
    BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/meta/NullNodeModel.js");
    BuildLibrary.loadJS(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/xiorkflow/meta/NullNode.js");
