...
public class FlglAqAction extends BaseAction {
private Dao dao;
private ODao oDao;
private FlglAqDAO flglAqDAO;
...
this.dataList = flglAqDAO.getPagedList(map);
return "list";
}
...
Map map = new HashMap();
map.put("lbbm", bm);
this.bean = flglAqDAO.queryForBean(map);
}
return "mod";
}
...
flglAqDAO.addFlglAq(bean);
} else if ("save".equals(action)) {
flglAqDAO.modFlglAq(bean);
}
}
return "save";
}
...
public FlglAqDAO getFlglAqDAO() {
return flglAqDAO;
}

public void setFlglAqDAO(FlglAqDAO flglAqDAO) {
this.flglAqDAO = flglAqDAO;
}

public FlglAq getBean() {
return bean;
}

public void setBean(FlglAq bean) {
this.bean = bean;
}
