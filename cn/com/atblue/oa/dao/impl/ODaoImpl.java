...
public class ODaoImpl extends SqlMapClientDaoSupport implements ODao {
    ...
    public List getPagedFwdwList(Map paramMap){
        return this.getSqlMapClientTemplate().queryForList("oa.dao.getPagedFwdwList", paramMap);
    }
    ...
    public String getSpyjByItemIdAndProcessId(String itemId,String processId){
        ...
        map.put("processId",processId);
        return  (String)this.getSqlMapClientTemplate().queryForObject("oa.dao.getSpyjByItemIdAndProcessId", map);
    }
}
