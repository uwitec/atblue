            ...
            <td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablett" style="BORDER-COLLAPSE: collapse">
                    ...
                    <tr>
                        ...
                        <td class="tdadd"><input name="orgnization.orgnaName" type="text" id="orgnaName"  value="${orgnization.orgnaName}"/></td>
                    </tr>
                    <tr>
                        <td class="tdadd">顺序：</td>
                        <td class="tdadd"><input name="orgnization.orgnaOrder" type="text" id="orgnaOrder" value="${orgnization.orgnaOrder}"/></td>
                    </tr>
                    <tr>
