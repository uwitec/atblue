...
<form action="FlglJh_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="jhbm" value="<s:property value="jhbm"/>"/>
    <input type="hidden" name="bean.jhbm" value="<s:property value="bean.jhbm"/>"/>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <%--<tr>--%>
                            ...
                            <%--<td class="head_right" align="left" style="text-align: left">--%>
                                    <%--<input type="text" name="bean.jhbm" value="<s:property value="bean.jhbm"/>"/>--%>
