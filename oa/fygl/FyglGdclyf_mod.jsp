...
<form action="FyglGdclyf_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="gdclbm" value="<s:property value="gdclbm"/>"/>
    <input type="hidden" name="bean.gdclbm" value="<s:property value="bean.gdclbm"/>"/>
                ...
                <div id="scrollDiv"
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.ch" value="<s:property value="bean.ch"/>"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.yxtb" value="<s:property value="bean.yxtb"/>"/>
                        ...
                        <tr>
                            ...
                            <td class="head_right" align="left" style="text-align: left">
                                    <input type="text" name="bean.yfxj" value="<s:property value="bean.yfxj"/>" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/>
