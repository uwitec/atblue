...
<form action="FyglLhfw_save.d" name="form1" method="post">
    <input type="hidden" name="action" value="save"/>
    <input type="hidden" name="lhfwbm" value="<s:property value="lhfwbm"/>"/>
    <input type="hidden" name="bean.lhfwbm" value="<s:property value="bean.lhfwbm"/>"/>
