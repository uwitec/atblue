                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <input type="button" class="button" onclick="window.location = 'FyglScfzlw_add.d';" style="width:40px"  value='新增'>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="0"  id="tab_id" name="tab_id"
                ...
                <s:iterator value="dataList" status="status">
                    <tr onclick="setSelected(this,'tab_id','tr_head','<s:property value="SCFZLWBM"/>')">
                        ...
                        <td class="form_th" style="text-align: left" nowrap><s:property value="RCYF"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="GDCL"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="XLF"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="AJF"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="BFWX"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="PBLW"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="WBLWF"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="RHS"/>&nbsp;</td>
                        <td class="form_th" style="text-align: left" nowrap><s:property value="AKLLW"/>&nbsp;</td>
                        <td class="form_th" style="text-align: center" nowrap>
                            <a href="./FyglScfzlw_mod.d?bm=<s:property value="SCFZLWBM"/>">[编辑]</a>&nbsp;
                            <a href="javascript:onDelete('./FyglScfzlw_del.d?bm=<s:property value="SCFZLWBM"/>');">[删除]</a>&nbsp;
                        </td>
                    </tr>
                </s:iterator>
            </table>
