...
Ext.onReady(function(){
	tabpanel = new Ext.TabPanel({
	   ...
	   items:[
	   {
	       ...
	       closable: false,     //允许关闭
	       //通过html载入目标页
	       html: '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="index_sign.jsp"  name="frame"></iframe>'
	   } ,
	{
	    'id': '当前通知',
	    autoScroll: true,   //溢出时显示滚动条
	    ...
	    closable: false,     //允许关闭
	    //通过html载入目标页
	        html: '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="index_expired.jsp"  name="frame" id="frame" ></iframe>'
	}
       ]
    });
